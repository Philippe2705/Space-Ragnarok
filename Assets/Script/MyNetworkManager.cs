...
{
    //Les différents Vcx
    public GameObject smallShip, cruiser, frigate, batleShip, ragnarok;
    public Sprite smallShipSprite, cruiserSprite, frigateSprite, batleShipSprite, ragnarokSprite; //Les Sprites des ships
    ...
    void Start()
    {
        ...
        else { setLocalShip(0); } // Ship par défaut
    }
    ...
    public void setLocalShip(int shipIDChoose) // Change le Vcx a spawn et ses propriétés
    {
        ...
        {
            shipSettings.shipPrefab = batleShip;
            shipSettings.speedFactor = 0.7f;
            shipSettings.armor = 0;
            shipSettings.numberOfGunsOnEachSide = 8;
            shipPreview.GetComponent<Image>().sprite = batleShipSprite;
        }
